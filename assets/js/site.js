(() => {
  ...
  const COPY = {
    pt: {
      ...
      community: 'Comunidade', partners: 'Conheça também', members: 'Organização', events: 'Eventos', projects: 'Projetos',
      conduct: 'Código de conduta', fullConduct: 'Ver Código de Conduta completo ↗', blog: 'Blog', upcoming: 'Próximos', past: 'Eventos anteriores',
      eventsIntro: 'Nos encontramos para trocar conhecimento. A agenda é mantida em data/events.json.', volunteersIntro: 'Pessoas que contribuem ou já contribuíram com a organização da comunidade.',
    ...
    en: {
      ...
      community: 'Community', partners: 'Discover also', members: 'Organization', events: 'Events', projects: 'Projects',
      conduct: 'Code of conduct', fullConduct: 'View the full Code of Conduct ↗', blog: 'Blog', upcoming: 'Upcoming', past: 'Past events',
      eventsIntro: 'We get together to share knowledge. The schedule lives in data/events.json.', volunteersIntro: 'People who contribute or have contributed to the community organization.',
